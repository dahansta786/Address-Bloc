...
RSpec.describe AddressBook do
    # #1 create new instance of the AddressBook model and assign it to the variable named book using the let syntax provided by RSpec
    ...
    describe "#import_from_csv" do
        it "imports the correct number of entries" do
            # #3 call the import_from_csv method on the book object which is of type AddressBook (our data model)
    ...
    context "importing entries from entries_2.csv" do
        it "imports the correct number of entries" do
